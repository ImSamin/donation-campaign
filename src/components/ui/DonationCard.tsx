      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        {displayedData.map((item: any, index: number) => {
          ...
          return (
            <div
              key={item.id}
              className={`bg-${currentColor}-600 bg-opacity-25 rounded-lg overflow-hidden shadow-md flex`}
            >
              {/* Left Side */}
              <div className="w-1/3">
                <Image
              ...
              <div className="p-4 px-5 w-2/3">
                <p
                  className={`text-sm text-${currentColor}-700 bg-${currentColor}-600 bg-opacity-50 rounded-full inline-block px-3 py-1 uppercase font-semibold tracking-wide`}
                >
                  {item.category}
                </p>
                ...
                <p className={`text-${currentColor}-700 font-semibold mt-2`}>
                  $100
                </p>
